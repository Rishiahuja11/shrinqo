...
// this bundle dir so Netlify zips a self-contained function. server.js reads
// its static files relative to __dirname, so public must sit beside it.
const SERVER_MODULE = path.join(__dirname, '_server', 'server.js');

const { handleRequest } = require(SERVER_MODULE);
