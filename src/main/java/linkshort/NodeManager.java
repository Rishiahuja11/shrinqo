...
public class NodeManager {
    ...
    public NodeManager(Logger log, String command, String workingDir) {
        this(log, command, workingDir, Collections.emptyMap());
    }

    public NodeManager(Logger log, String command, String workingDir, Map<String, String> extraEnv) {
        this.log = log;
        this.command = command;
        this.workingDir = workingDir;
        this.extraEnv = extraEnv == null ? Collections.emptyMap() : extraEnv;
    }
            ...
            while (running) {
                try {
                    ...
                    if (p != null && !p.isAlive()) {
                        ...
                        if (!portDetected && p != null && p.isAlive()) {
        ...
        try {
            ...
            for (String part : parts) {
                if (part.contains(":")) {
                    ...
                    int port = Integer.parseInt(lastColon);
